...
**[Portfolio]** is a learning project in which it is required to implement HTML/CSS linters.. And to build a professional portfolio webpage based on Figma template using Bootstrap framework..

## 🛠 Built With <a name="built-with"></a>
Visual Studia Code, Figma and HTML/CSS linters, Bootstrap.
...
In order to use this project.. Clone this repository to your desired folder by pasting this command in your command line interface:
  ...
  https://github.com/tajemouti/Portfolio-with-bootstrap.git

Or you can just click [here](https://tajemouti.github.io) to access the online portfolio homepage,
Or you can just click [here](https://mohammadyaser.github.io/) to access the online portfolio homepage of my collaborator.
...
I would like to thank my coding partner [Mohammad Yaser](https://github.com/MohammadYaser) .. I really appreciate your contribution..
